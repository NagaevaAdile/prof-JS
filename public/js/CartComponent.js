    ...
    <h2 v-if=" cartItems.length === 0">cart is empty</h2>
        <div v-else >
            <div class="cart-block" v-show="showCart">
                <h2> amount: {{ this.cartItems.reduce((summ, item) => summ + item.quantity, 0) }};  sum:{{ this.cartItems.reduce((summ, item) => summ + item.quantity*item.price, 0) }}$</h2>
...
Vue.component('cart-item', {
    ...
    template: `
    <div class="cart-item">
        <img class="cartImg" src="{{ cartItem.img_product }}" alt="Some img" width="130" height="auto">
